...
| English visual/product design | `static-web/ENGLISH_PRODUCT_BRIEF.md` + exact accepted surface owner |
...
- Task-first; First Learning remains targeted/skippable where its exact owner says so.
- Wrong / Uncertain is evidence, not automatic diagnosis or mandatory repair.
- Objective tasks preserve native whole-task geometry and answer gating.
- Translation / Writing preserve learner first output before reference or Chat help.
- Lookup does not silently mutate Lexical learning state.

...
It does not own medical Core, learner-support semantics, Work Cursor, or Kian's private learner state.
...
- **L PASS** — shared study policy plus `a2-respiratory-learning.json` define the direct **12-Block / 62-Logic-Group** first-learning route, Lecture-first learning, KP Recall, Block Recall, System Recall before questions, W/U repair and post-question Recall.
...
`FINAL_A1_PR_QA_AND_MERGE` is historical: PR #12 was merged on 2026-09-12 with merge commit `61e2c1b32aeadeedd1b3bf4f6f6a43a7734509f2`. It is not a current work item.
...
This owner preserves the current readiness claims and decisive evidence from the prior `knowledge/learner/acceptance-status.json`, while removing stale Work Cursor / acceptance-queue responsibility from the Acceptance Truth layer.

The detailed predecessor remains recoverable through Git history if an explicitly bounded historical audit is required; normal Current work uses this file.

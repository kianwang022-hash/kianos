...
> **主提示**：主轴＝β₁阻断后 HR、收缩力、耗氧↓ + 舒张期↑；讲义再保留非缺血区/缺血区再分配这一条次级解释
...
> **边界**：第 3 条不是所有 β 受体阻断剂抗心绞痛都必须具备的统一主机制，尤其不能把“必须阻断 β₂”学成结论。306 第一优先级仍是 **降 HR / 降收缩力 → 降耗氧 + 延长舒张灌注时间**；完整冠心病药物选择归 B6。

### KP32｜硝酸酯抗心绞痛：供需两端

> **主提示**：扩静脉、扩动脉、冠脉/侧支舒张分别怎样影响前负荷、后负荷、室壁张力、耗氧和局部供氧
...
![冠脉调节与硝酸酯](Block1_正常机械循环_v6_assets/09_冠脉调节与硝酸酯供需图.png)

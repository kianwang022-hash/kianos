...
**Latest exact checkpoint:** `content/lexical/audit/knowledge-reacceptance/batches/r12-2141-2180-core-expansion.json` — R12 ordinals 2141–2180 Core + Expansion reconciliation complete for all historically approved affected owners in that range; 10 Core decisions checked (2 Current-correct / 8 defective) and 8 Expansion owner-groups checked (1 Current-correct / 2 presentation-only gaps / 5 phrase-landing gaps). No Natural Owner semantic mutation was performed. New real P0 carrier-loss states were reproduced at `word:glove` and `word:gradual`; severe carrier inversion was also reproduced at `word:goose`.  
**Next action:** continue the bounded R12 Core + Expansion reconciliation from ordinal 2181 onward against the historical approved authority already named by Issue #6. Keep Contrast checkpoint A as existing evidence; do not restart a 7,946-word review. After R12 coverage is complete, continue R13+ and later build one consolidated exact repair inventory before semantic mutation.

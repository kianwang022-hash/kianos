...
**Latest exact checkpoint:** `content/lexical/audit/knowledge-reacceptance/batches/r12-2181-2220-core-expansion.json` — R12 ordinals 2181–2220 Core + Expansion reconciliation complete for all historically approved affected owners in that range; 12 Core decisions checked (1 Current-correct / 11 defective) and 9 Expansion owner-groups checked (2 Current-correct / 2 presentation-only gaps / 5 phrase-landing gaps). No Natural Owner semantic mutation was performed. Severe overmerge/carrier loss was reproduced at `word:grip`.  
**Next action:** continue the bounded R12 Core + Expansion reconciliation from ordinal 2221 onward against the historical approved authority already named by Issue #6. Keep Contrast checkpoint A as existing evidence; do not restart a 7,946-word review. After R12 coverage is complete, continue R13+ and later build one consolidated exact repair inventory before semantic mutation.

...
**Latest exact checkpoint:** `content/lexical/audit/knowledge-reacceptance/batches/r13-2421-2440-core-expansion.json` — R13 ordinals 2421–2440 Core + Expansion reconciliation complete for all historically approved affected owners in that range; 4 Core decisions checked (**1 Current-correct / 3 defective**) and 5 Expansion owner-groups checked (**1 Current-correct / 2 partial landing gaps / 2 full phrase-or-construction landing gaps**). Natural Owner semantic mutation remained **0**. A new P0 carrier-loss state was reproduced at `word:i`. The immediately preceding `r13-2381-2420-core-expansion.json` checkpoint checked 6 Core decisions (**0 Current-correct / 6 defective**) and 4 Expansion owner-groups (**1 Current-correct / 1 partial / 2 full landing gaps**), reproducing new P0 carrier loss at `word:hostile` and `word:how`. R13 cumulative through ordinal 2440 is now **41 Core decisions = 9 Current-correct / 32 defective** and **24 Expansion owner-groups = 8 Current-correct / 4 partial / 12 full landing gaps**.  

...
**Latest exact checkpoint:** `content/lexical/audit/knowledge-reacceptance/batches/r13-2481-2500-core-expansion.json` — R13 ordinals 2481–2500 Core + Expansion reconciliation complete for all historically approved affected owners in that range; 5 Core decisions checked (**2 Current-correct / 3 defective**) and 5 Expansion owner-groups checked (**1 Current-correct / 1 partial landing gap / 3 full phrase-or-construction landing gaps**). Natural Owner semantic mutation remained **0**. A new P0 carrier-loss state was reproduced at `word:in`, and severe carrier inversion at `word:independence`. The immediately preceding `r13-2441-2480-core-expansion.json` checkpoint checked 13 Core decisions (**3 Current-correct / 10 defective**) and 11 Expansion owner-groups (**3 Current-correct / 5 partial / 3 full landing gaps**), reproducing new P0 carrier loss at `word:image` and `word:immune` plus severe carrier inversion at `word:illuminate`, `word:impact`, `word:impress`, and `word:impression`. R13 cumulative through ordinal 2500 is now **59 Core decisions = 14 Current-correct / 45 defective** and **40 Expansion owner-groups = 12 Current-correct / 10 partial / 18 full landing gaps**.  
...
**Next action:** continue bounded R13 Core + Expansion reconciliation from ordinal **2501** using only historically affected Current Natural Owners / Relations. Reconcile the 45 R13 Contrast targets separately after/beside bounded R13 coverage as Issue #6 requires. Do not repair Natural Owners yet; later build one consolidated exact repair inventory before semantic mutation.

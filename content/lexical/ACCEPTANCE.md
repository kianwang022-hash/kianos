...
- commit `34ac4336f108cf18ed0947f2f00457aa24cf4b31` — **R18 coverage complete, not repaired** under dual-track review: 103 Core = **20 Current-correct / 83 defective-or-upgrade-required**, including **17 Active=0 P0 owners** and **7 dead construction anchors across 5 words**; eight historical Expansion transport lines were normalized into **122 mandatory learner-value surface/family groups = 54 Current-correct / 26 partial-or-presentation-or-wrong-anchor / 42 missing**; 71 historical Contrast targets were re-owned as **64 genuine cross-word Relation targets = 2 Current-correct / 3 partial / 59 missing**, plus **7 Word/Identity/Form targets = 7 full gaps**. A 12-owner Core-direct-pass calibration sample found **0 new systematic Core defects**. Fresh latest-target judgments refined `profession`, `promise`, `property`, `queer`, `rabbit`, `range`, `real`, `recession`, `recipe`, `rectify`, `refuse`, `regime/regimen`, `relation`, `remark`, `republican/Republican`, and `research`. Semantic mutation and learner-state mutation remained **0**;
- commit `4ce96fe56768294234220ab9aa9e43d23f9545ac` — **R19 coverage complete, not repaired** under dual-track review: 78 Core = **5 Current-correct / 73 defective-or-upgrade-required**, including **45 Active=0 P0 owners** and **5 dead construction anchors across 3 words** (`respond`, `response`, `see`); 125 historical Expansion owner words were treated as coverage metadata while exact acceptance used **92 named mandatory learner-value surface/family groups = 42 Current-correct / 21 partial-or-presentation-or-wrong-anchor / 29 missing**; 56 historical Contrast targets were re-owned as **50 genuine cross-word Relation targets = 0 Current-correct / 1 partial / 49 missing**, plus **6 Word/Identity/Form targets = 1 Current-correct / 2 partial / 3 missing**. Overall Contrast = **1 complete / 3 partial / 52 missing**. A 12-owner Core-direct-pass calibration sample found **0 new systematic Core defects**. Fresh latest-target judgments refined `restrict`, `resultant`, `resume/résumé`, `retire`, `reward`, `right`, `round`, `saddle`, `sake`, `sanction`, `scenario`, `saw`, `set`, `sex/gender`, `shall`, and `ship`. Semantic mutation and learner-state mutation remained **0**;
- commit `3d28c0d5459935120e401ecf664a815a404849ea` — **R20 coverage complete, not repaired** under dual-track review: 123 Core = **5 Current-correct / 118 defective-or-upgrade-required**, including **14 Active=0 P0 owners** and no new dead construction anchors; 174 historical Expansion owner words are coverage metadata while exact acceptance uses **93 named high-transfer learner surface/family groups = 34 Current-correct / 41 partial-or-presentation-or-wrong-anchor / 18 missing**; 63 historical Contrast targets were re-owned as **61 genuine cross-word Relation targets = 1 Current-correct / 2 partial / 58 missing**, plus **2 Word/Identity/Form targets = 0 Current-correct / 1 partial / 1 missing**. Overall Contrast = **1 complete / 3 partial / 59 missing**. A 12-owner Core-direct-pass calibration sample found **0 new systematic Core defects**. R20 also hardened the generic bulk surface reader so phrase particles/prepositions, structural function words and morphology do not create avoidable false missing labels. Fresh latest-target judgments refined `short`, `sick`, `slave`, `smart`, `so`, `socialism`, gender-marked identity (`spokesman/sportsman/statesman`), `speciality/specialty`, invariant `species`, `sometime/sometimes/some time`, and `sound`; `shove`, `show`, `skill`, `square`, and `stick` were explicitly accepted as Current-already-better at the Core layer. Semantic mutation and learner-state mutation remained **0**;
- commit `e768b554d65e8b34e47d467f0417d574bba0174c` — **R21 coverage complete, not repaired** under dual-track review: 91 Core = **6 Current-correct / 85 defective-or-upgrade-required**, including **10 Active=0 P0 owners** and **4 dead construction anchors across 4 words** (`stipulate`, `strip`, `teach`, `think`); 175 historical Expansion owner words are coverage metadata while exact acceptance uses **82 named high-transfer learner surface/family groups = 51 Current-correct / 4 partial-or-presentation-or-wrong-anchor / 27 missing**; 63 historical Contrast targets were re-owned as **61 genuine cross-word Relation targets = 0 Current-correct / 0 partial / 61 missing**, plus **2 Word/Identity/Form targets = 1 Current-correct (`table` regional contronym) / 0 partial / 1 missing (`tear` heteronym)**. Overall Contrast = **1 complete / 0 partial / 62 missing**. A 12-owner Core-direct-pass calibration sample found **0 new systematic Core defects**. Fresh latest-target judgments refined `straight`, digital `stream`, sensitive `suicide` usage, `sweat`, `switch`, high-frequency `take`, modern decline/failure `tank`, `tear` heteronym, fever `temperature`, broad `technology`, `television`, singular-they family (`their/theirs/them/they`), `theory`, grammatical-form `thought`, `thoughtful`, and `terrific`; `strike`, `stroke`, `stumble`, `table`, `technical`, and `theoretical` were explicitly accepted as Current-already-better at Core level. Semantic mutation and learner-state mutation remained **0**;
- commit `69698e69a38df9de9428152964bac0a76ab5bced` — **R22 coverage complete, not repaired** under dual-track review: 83 Core = **7 Current-correct / 76 defective-or-upgrade-required**, including **16 Active=0 P0 owners** and **2 dead construction anchors** (`train`, `trap`); historical Expansion metadata enumerates **181 owner target words** but omits at least `trifle` despite the same authority explicitly approving BrE dessert `trifle`, so owner coverage metadata is not treated as a semantic veto and exact acceptance uses **98 named high-transfer learner surface/family groups = 46 Current-correct / 19 partial-or-presentation-or-wrong-anchor / 33 missing**; 63 historical Contrast targets were re-owned as **61 genuine cross-word Relation targets = 1 Current-correct (`transaction/transition`) / 60 missing**, plus **2 Word/Identity/Form targets = 2 missing** (`tire/tyre`, noun/verb `use` pronunciation). Overall Contrast = **1 complete / 62 missing**. A 12-owner Core-direct-pass calibration sample found **0 new systematic Core defects**. Fresh latest-target judgments refined infinitival/directional `to`, digital `token`, BrE `torch`, modern `traffic`, `transfer`, public `transit`, BrE dessert `trifle`, `turkey/Turkey` case identity, noun/verb `use` pronunciation, offensive `vegetable` person-label handling, vector `velocity`, and `vice/vise`; `tip`, `touch`, `turn`, `unanimous`, `understand`, `verify`, and `vicious` were explicitly accepted as Current-already-better at Core level. R22 also generalized the bulk parser for inline Contrast lists and explicit learner surfaces omitted from historical owner metadata. Semantic mutation and learner-state mutation remained **0**.

R12–R22 completion means **audit/target coverage**, not K PASS and not semantic repair. Current Natural Owners / Relation Owners remain unchanged by these checkpoints.

...
- commit `c490b86494af10fd03722ea7679f211711c07e84` — exact R12 Core + Expansion reconciliation for ordinals 2141–2180: 10 historically approved Core decisions checked (**2 Current-correct / 8 defective**) and 8 Expansion owner-groups checked (**1 Current-correct / 2 presentation-only gaps / 5 phrase-landing gaps**), with **0 semantic mutation**. This checkpoint reproduced new real P0 carrier-loss states at `word:glove` and `word:gradual`, plus severe carrier inversion at `word:goose`;
- commit `23832cb058e241a82276504dbd88a2e36286792b` — exact R12 Core + Expansion reconciliation for ordinals 2181–2220: 12 historically approved Core decisions checked (**1 Current-correct / 11 defective**) and 9 Expansion owner-groups checked (**2 Current-correct / 2 presentation-only gaps / 5 phrase-landing gaps**), with **0 semantic mutation**. This checkpoint reproduced severe overmerge/carrier loss at `word:grip` and confirmed multiple approved familiar-new/phrase targets remain absent. K therefore remains BLOCKED.

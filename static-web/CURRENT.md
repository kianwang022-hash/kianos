...
The managed local site builds a staging projection before replacing the served site. Its live SHA and health come from `/__kianos-current.json` and the doctor, never a copied value here. Source code being merged is distinct from the local site actually serving it.

...
export function politicsNavigation(base = '/') {
  return [
    ...
    { key: 'learn', label: '学习', href: `${base}politics/learn/`, matchPath: /^politics\/(?:learn(?:\/|$)|(?!practice(?:\/|$)|review(?:\/|$)|practice-review(?:\/|$)|memory(?:\/|$)).+)/ },
    { key: 'practice', label: '肖1000', href: `${base}politics/practice/`, matchPath: /^politics\/practice(?:\/|$)/ },
    { key: 'review', label: '复习', href: `${base}politics/review/`, matchPath: /^politics\/(?:review|practice-review|memory)(?:\/|$)/ }
  ];
}

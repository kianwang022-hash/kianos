...
import { practiceReviewPayload } from '../../../lib/politicsPracticeView.mjs';
...
export function getStaticPaths() {
  ...
  return catalog.questions.map(({ id }) => ({ params: { id }, props: { payload: practiceReviewPayload(catalog, id) } }));
}

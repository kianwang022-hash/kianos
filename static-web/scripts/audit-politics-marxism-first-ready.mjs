...
// Whole-item Source audit: correct-option overlap alone does not establish readiness.
const K03_EXPECTED = new Set([
  'X1000-MARX-S-028','X1000-MARX-S-039','X1000-MARX-M-027',
  'X1000-MARX-M-028','X1000-MARX-M-030'
]);

...
const sleep=ms=>new Promise(r=>setTimeout(r,ms));const report={scope:'Politics whole-subject readability + five native frames -> Workbench; isolated state; SELF',checks:[],errors:[]};let browser;
try{

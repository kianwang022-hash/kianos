...
if (politicsManifest?.knowledge_and_learning_content?.subject_status?.ethics_law !== 'SOURCE_KNOWLEDGE_CONTENT_CLOSED_C00_TO_C06_WITH_SUBJECT_MAP') blockers.push({ chapter: 'subject', code: 'ROOT_MANIFEST_NOT_CONTENT_CLOSED' });

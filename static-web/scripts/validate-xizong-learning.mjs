...
has(enhancerUi, 'resume:', 'study-packet-exact-resume-missing');
has(enhancerUi, 'ttsx:', 'study-packet-ttsx-state-missing');
has(enhancerUi, 'collectXizongRetainedEvidence', 'study-packet-practice-evidence-missing');

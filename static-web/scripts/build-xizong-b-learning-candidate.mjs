...
const output = {
  ...
  question_stage:{timing:'AFTER_REAL_SYSTEM_LEARNING_AND_PRE_QUESTION_SYSTEM_RECALL',exact_membership_gate:'CURRENT_B_QUESTION_SCOPE_ACCEPTED',question_scope_owner:'content/xizong/knowledge/learner/b-digestive-metabolic-endocrine-tumor-question-scope.json',question_order_owns_learning:false,lecture_attached_questions:'remain with original Lecture / MarginNote',repair:'Wrong / Uncertain only; precise Block/KP routing uses reviewed relations only',whole_paper_holdout:'learner-selected and private; excluded wholesale from ordinary System sweep'},

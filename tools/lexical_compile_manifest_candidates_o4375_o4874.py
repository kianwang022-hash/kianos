...
def main():
    ...
    for o,(word,f) in sorted(bs.items()):
        ...
        # Backticked learner patterns that are not sense IDs / ordinals / verdict tags.
        pats=[]
        ...
        unresolved=[]
        # Explicit missing-sense/add/reuse/new language without a named stable carrier needs identity resolution.
        ...
        # Pure explicit reactivation(s) with no other mutation class is mechanically ready.

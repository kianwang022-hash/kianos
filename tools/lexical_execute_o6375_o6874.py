#!/usr/bin/env python3
"""Continuous/resumable executor for Issue #288 / o6375-o6874.

Semantic authority is frozen in content/lexical/semantic-reconciliation/o6375-o6874.md.
...
def validate_manifest():
    ...
    if len(src)!=302: raise RuntimeError(f'SOURCE_COUNT_DRIFT {len(src)}')
    ...
    return {'sources':302,'patches':len(keys),'manifest_files':10}

def checkpoint_sources(i):
    lo=6375+50*i; hi=lo+49; return lo,hi,tuple(sorted(o for o in source_set() if lo<=o<=hi))

#!/usr/bin/env python3
"""Continuous/resumable executor for Issue #256 / o5875-o6374.

Semantic authority is frozen in content/lexical/semantic-reconciliation/o5875-o6374.md.
...
REMOTE_ALLOWED={227,2567,2827,2967,3063,3472,4281,5558,7182,7671}
...
def apply_op(store,o,op,sense_touched,explicit_core,relation_ids):
    ...
    if k=='rewrite':
        ...
        if op.get('usage_note') or op.get('register'):
...
def apply_checkpoint(i):
    validate_manifest(); patches=load_patches(); lo,hi,src=checkpoint_sources(i); current=set(src)

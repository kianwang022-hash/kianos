#!/usr/bin/env python3
"""Continuous/resumable executor for Issue #301 / o7375-o7874.

Semantic authority is frozen in content/lexical/semantic-reconciliation/o7375-o7874.md.
...
def validate_manifest():
    ...
    if len(src)!=287: raise RuntimeError(f'SOURCE_COUNT_DRIFT {len(src)}')
    ...
    return {'sources':287,'patches':len(keys),'manifest_files':10}

def checkpoint_sources(i):
    lo=7375+50*i; hi=lo+49; return lo,hi,tuple(sorted(o for o in source_set() if lo<=o<=hi))
